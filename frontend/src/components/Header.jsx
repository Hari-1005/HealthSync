...
const Header = () => {
  return (
    <div className='bg-primary flex flex-col md:flex-row flex-wrap rounded-lg px-6 md:px-10 lg:px-20'>
        {/* first-section */}
        <div className='md:w-1/2 text-center md:text-start text-white flex flex-col justify-center items-start gap-4 py-10 md:py-[10vw] md:mb-[-30px] m-auto'>
            ...
            <a className='bg-white flex items-center gap-2 text-gray-600 text-sm px-8 py-3 rounded-full m-auto md:m-0 hover:scale-105 transition-all duration-300' href="#specality">Book appointment <img src={assets.arrow_icon} alt="arrow-icon" className='w-3' /></a>
        </div>
